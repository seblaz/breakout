...
local function GenerateQuads(atlas, tilewidth, tileheight)
...
local function GenerateQuadsPaddles(atlas)
    local x = 0
    local y = 64
...
local function GenerateQuadsBalls(atlas)
    local x = 96
    local y = 48
...
local Frames = {
    ...
    ['power_ups'] = GenerateQuadsPowerUps(Constants.gTextures['main']),
